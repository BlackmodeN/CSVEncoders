...
public class Transfer {
	...
	public static void TransCode(File url) throws Throwable{
		path = url.getAbsolutePath();
		String name = url.getName();
		if (url.exists()) {
			System.out.println("当前正在处理文件编号："+name);
			convert(path, "UTF-8", "GBK", new FilenameFilter() {
				@Override
